...
-----------------------------------------------------------------
Purpose:
This program orders with sequal statements a random hand set of 10 
cards by color, suit, face and value.
-----------------------------------------------------------------
*/
...
class LINQStatements {
    static void Main() {
        ...
        IEnumerable<Card> clubCardsOnlyQuery =
           from card in playerHand.GetCards()
           where card.Suit == "Clubs" // || card.Suit == "Spades"
           orderby card.Value
           select card;
