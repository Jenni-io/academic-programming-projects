...
-----------------------------------------------------------------
Purpose: The class creats a "deck" of card objects and suffles them.
-----------------------------------------------------------------
*/
public class Deck {
    // Private constants
    ...
    public Deck(bool buildDeck = true) {
        ...
        //A new deck will be built
        if (buildDeck) {
            this.BuildDeck();   // Creates all 52 playing cards
            this.Shuffle();
        } // end if
    } // end constructor
